      ...
      <div class="modal-body">
        ...
        <form action="{{route('webinars.store')}}" enctype="multipart/form-data" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="file" class="form-control @error('webinar_image') is-invalid @enderror" id="userImage" name="webinar_image" >
          </div>
          <div class="mb-3">
            <label for="firstName" class="form-label">Host Name</label>
            <input type="text" class="form-control @error('host_name') is-invalid @enderror" id="firstName" name="host_name" required>
          </div>
          <div class="mb-3">
            <label for="firstName" class="form-label">Agenda</label>
            <input type="text" class="form-control @error('agenda') is-invalid @enderror" id="firstName" name="agenda" required>
          </div>
            <div class="mb-3">
              <label for="firstName" class="form-label">Date</label>
              <input type="date" class="form-control @error('date') is-invalid @enderror" id="firstName" name="date" required>
            </div>
