          ...
          <form id="editUserForm{{$educations->id}}" action="{{ route('education.update', $educations->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="modal-body">         
                  <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="first_name{{$educations->grade_level}}" name="grade_level" value="{{$educations->grade_level}}">
                  </div> 
                  <div class="mb-3">
                    <label for="first_name{{$educations->id}}" class="form-label">School Year</label>
                    <input type="text" class="form-control" id="first_name{{$educations->school_year}}" name="school_year" value="{{$educations->school_year}}">
                </div> 
                <div class="mb-3">
                  <label for="first_name{{$educations->id}}" class="form-label">School Name</label>
                  <input type="text" class="form-control" id="first_name{{$educations->school_name}}" name="school_name" value="{{$educations->school_name}}">
              </div> 
              <div class="mb-3">
                <label for="first_name{{$educations->id}}" class="form-label">Address</label>
                <input type="text" class="form-control" id="first_name{{$educations->address}}" name="address" value="{{$educations->address}}">
            </div> 
