    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="signup.html" class="nav-item nav-link"><i class="fas fa-cogs me-2"></i>Skills</a>
                <a href="404.html" class="nav-item nav-link"><i class="fas fa-briefcase me-2"></i>Experiences</a>
                <a href="blank.html" class="nav-item nav-link"><i class="fas fa-calendar-alt me-2"></i>Webinar</a>
                <a href="blank.html" class="nav-item nav-link"><i class="fas fa-address-book me-2"></i>Contacts</a>
                <hr class="my-2">
                <a href="{{ route('interests.index') }}" class="nav-item nav-link"><i class="fas fa-book me-2"></i>My Blog</a>
                <hr class="my-2">
                {{-- <hr class="my-2">
                <div class="nav-item d-flex align-items-center">
                    <a href="{{route('user.create')}}" class="nav-item nav-link"><i class="fas fa-book"></i>My Blog</a>
                </div>
                <hr class="my-2"> --}}
